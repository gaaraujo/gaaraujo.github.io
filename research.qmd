...
::: {.research-theme-photo}
![](assets/images/research/rc-frame-damage-colombia.png){fig-alt="Post-earthquake damage to mid-rise reinforced concrete frame buildings in Colombia, showing exterior damage levels and component failures" width="240"}

Post-earthquake RC frame damage, Colombia ([Arteta et al., 2019](https://doi.org/10.1193/061218EQS144M)).
:::
:::
...
::: {.research-theme-photo}
![](assets/images/projects/opensees-logo.png){fig-alt="OpenSees logo" width="240"}

[OpenSees](https://opensees.github.io/OpenSeesDocumentation/index.html) — GPU-accelerated computing (active research).
:::
:::
